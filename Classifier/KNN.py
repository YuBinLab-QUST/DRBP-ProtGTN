...
for train, test in skf.split(X,y): 
    ...
    print('KNN:acc=%f,precision=%f,npv=%f,sensitivity=%f,specificity=%f,mcc=%f,f1=%f,roc_auc=%f,aupr=%f'
...
yscore_sum.to_csv('yscore_sum_KNN_KPLS.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_KNN_KPLS.csv')
...
data_csv.to_csv('KNN_PDB14189_KPLS.csv')
